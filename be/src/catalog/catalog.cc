...
Catalog::Catalog() {
  JniMethodDescriptor methods[] = {
    ...
    {"startEventProcessor", "([B)[B", &start_event_processor_},
...
Status Catalog::StartEventProcessor(const impala::TStartEventProcessorRequest& request,
    impala::TStartEventProcessorResponse *response) {
  return JniUtil::CallJniMethod(catalog_, start_event_processor_, request, response);
}
